...
exports.default = (prog) => {
    prog
        .command('ddoc build <src>', 'Build design document(s) from TypeScript soruce directory or file.')
        ...
        try {
            ...
            const tsconfigPath = path_1.default.isAbsolute(opts.config)
                ? opts.config
                : path_1.default.join(cwd, opts.config);
